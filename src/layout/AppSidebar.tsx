...
const AppSidebar: React.FC = () => {
        ...
        {items
          ...
          .map((nav, index) => {
            ...
            if (nav.subItems && (!filteredSubItems || filteredSubItems.length === 0)) {
              return null; // Skip if no sub-items are visible
            }
  ...
  return (
    <aside
      className={`fixed mt-16 flex justify-between flex-col lg:mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
    ...
    >
      <div className="flex flex-col h-[calc(100%-30px)]">
        <div
